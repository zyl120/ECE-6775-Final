...
// ==============================================================
#ifndef __block_mmul_mac_mubkb__HH__
#define __block_mmul_mac_mubkb__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(block_mmul_mac_mubkb) {
    ...
    SC_CTOR(block_mmul_mac_mubkb):  simcore_mac_0_U ("simcore_mac_0_U") {
