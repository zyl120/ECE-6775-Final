...
entity matrix_mult_b_buff_ram is 
    generic(
...
architecture rtl of matrix_mult_b_buff_ram is 
...
architecture arch of matrix_mult_b_buff is
    component matrix_mult_b_buff_ram is
        port (
            clk : IN STD_LOGIC;
...
begin
    matrix_mult_b_buff_ram_U :  component matrix_mult_b_buff_ram
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
