...
// ==============================================================
#ifndef __matrix_mult_mac_mncg__HH__
#define __matrix_mult_mac_mncg__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(matrix_mult_mac_mncg) {
    ...
    SC_CTOR(matrix_mult_mac_mncg):  simcore_mac_0_U ("simcore_mac_0_U") {
