...
// ==============================================================
#ifndef __block_mmul_srem_3cud__HH__
#define __block_mmul_srem_3cud__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(block_mmul_srem_3cud) {
    ...
    SC_CTOR(block_mmul_srem_3cud):  ACMP_srem_seq_U ("ACMP_srem_seq_U") {
