...
// ==============================================================
#ifndef __matrix_mult_mac_mZio__HH__
#define __matrix_mult_mac_mZio__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(matrix_mult_mac_mZio) {
    ...
    SC_CTOR(matrix_mult_mac_mZio):  simcore_mac_0_U ("simcore_mac_0_U") {
