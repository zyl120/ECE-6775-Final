...
// ==============================================================
#ifndef __mm_mult_mac_muladcud__HH__
#define __mm_mult_mac_muladcud__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(mm_mult_mac_muladcud) {
    ...
    SC_CTOR(mm_mult_mac_muladcud):  simcore_mac_0_U ("simcore_mac_0_U") {
