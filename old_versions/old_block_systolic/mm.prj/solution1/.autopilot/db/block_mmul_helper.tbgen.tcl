...
set C_modelArgMapList {[ 
	{ "Name" : "A", "interface" : "memory", "bitwidth" : 16, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "ii", "interface" : "wire", "bitwidth" : 7, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ ii sc_in sc_lv 7 signal 3 } 
	{ jj sc_in sc_lv 7 signal 4 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "ii", "direction": "in", "datatype": "sc_lv", "bitwidth":7, "type": "signal", "bundle":{"name": "ii", "role": "default" }} , 
...
set Spec2ImplPortList { 
	...
	ii { ap_none {  { ii in_data 0 7 } } }
	jj { ap_none {  { jj in_data 0 7 } } }
}
