...
set out_width 14
set exp i0*i1+i2
set arg_lists {i0 {8 0 +} i1 {7 0 +} m {14 0 +} i2 {7 0 +} p {14 0 +} c_reg {1} rnd {0} acc {0} }
set TrueReset 0
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename c \
    op interface \
    ports { c_address0 { O 14 vector } c_ce0 { O 1 bit } c_we0 { O 1 bit } c_d0 { O 32 vector } c_address1 { O 14 vector } c_ce1 { O 1 bit } c_we1 { O 1 bit } c_d1 { O 32 vector } } \
} "
} else {
