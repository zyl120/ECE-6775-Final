...
set C_modelArgList {
	{ a int 32 regular {array 400 { 1 3 } 1 1 }  }
	{ b int 32 regular {array 400 { 1 3 } 1 1 }  }
	{ c int 32 regular {array 400 { 0 3 } 0 1 }  }
}
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2", "3"],
		...
		"II" : "0",
		"VariableLatency" : "1", "ExactLatency" : "-1", "EstimateLatencyMin" : "35364", "EstimateLatencyMax" : "35364",
		"Combinational" : "0",
		"Datapath" : "0",
		"ClockEnable" : "0",
		"HasSubDataflow" : "0",
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "35364", "Max" : "35364"}
	, {"Name" : "Interval", "Min" : "35365", "Max" : "35365"}
]}
...
set Spec2ImplPortList { 
	a { ap_memory {  { a_address0 mem_address 1 9 }  { a_ce0 mem_ce 1 1 }  { a_q0 mem_dout 0 32 } } }
	b { ap_memory {  { b_address0 mem_address 1 9 }  { b_ce0 mem_ce 1 1 }  { b_q0 mem_dout 0 32 } } }
	c { ap_memory {  { c_address0 mem_address 1 9 }  { c_ce0 mem_ce 1 1 }  { c_we0 mem_we 1 1 }  { c_d0 mem_din 1 32 } } }
}
