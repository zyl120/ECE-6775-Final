...
// ==============================================================
#ifndef __matrix_mult_mul_mocq__HH__
#define __matrix_mult_mul_mocq__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(matrix_mult_mul_mocq) {
    ...
    SC_CTOR(matrix_mult_mul_mocq):  ACMP_smul_ss_U ("ACMP_smul_ss_U") {
