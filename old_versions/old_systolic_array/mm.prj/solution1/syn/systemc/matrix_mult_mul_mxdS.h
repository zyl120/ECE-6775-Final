...
// ==============================================================
#ifndef __matrix_mult_mul_mxdS__HH__
#define __matrix_mult_mul_mxdS__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(matrix_mult_mul_mxdS) {
    ...
    SC_CTOR(matrix_mult_mul_mxdS):  ACMP_smul_ss_U ("ACMP_smul_ss_U") {
