...
// ==============================================================
#ifndef __block_mmul_mac_mudEe__HH__
#define __block_mmul_mac_mudEe__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(block_mmul_mac_mudEe) {
    ...
    SC_CTOR(block_mmul_mac_mudEe):  simcore_mac_0_U ("simcore_mac_0_U") {
