...
HLS_SOURCES = ../../../../mm_mult_test.cc ../../../../mm_mult.cc
...
$(ObjDir)/mm_mult_test.o: ../../../../mm_mult_test.cc $(ObjDir)/.dir
	$(Echo) "   Compiling ../../../../mm_mult_test.cc in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CC) ${CCFLAG} -c -MMD -std=c++11 -Wno-unknown-pragmas -Wno-unknown-pragmas  $(IFLAG) $(DFLAG) -DNDEBUG $< -o $@ ; \

-include $(ObjDir)/mm_mult_test.d
