...
// ==============================================================
#ifndef __mm_mult_mul_mul_1bkb__HH__
#define __mm_mult_mul_mul_1bkb__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(mm_mult_mul_mul_1bkb) {
    ...
    SC_CTOR(mm_mult_mul_mul_1bkb):  ACMP_smul_ss_U ("ACMP_smul_ss_U") {
